...
// this will be broken for 10.7... Then it probably will be time to remove it altogether and drop Tiger compatibility
// Note : CGFloat is not defined in osx Tiger, hence the define, but is defined in Leopard and Snow Leopard.
